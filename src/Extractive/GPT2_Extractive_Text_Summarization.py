...
def extractive_summarization_gpt2(original_text, num_sentences=3):
    ...
    # Get GPT-2 embeddings for each token in the input text
    with torch.no_grad():
...
"""
summary = extractive_summarization_gpt2(original_text)
